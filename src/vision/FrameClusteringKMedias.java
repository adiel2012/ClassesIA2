 ...
 * @author Adiel
 */
public class FrameClusteringKMedias extends javax.swing.JFrame {

    /**
     * Creates new form FrameClusteringKMedias
     */
    BufferedImage img;

    public FrameClusteringKMedias() {
        initComponents();

        final OwnPanel ownPanel1 = new OwnPanel();
        final OwnPanel ownPanel2 = new OwnPanel();
        ...
        try {
            img = ImageIO.read(new File("tulipanes.jpg"));
...
//                BufferedImage transformada = Utils.suavizar(img);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrameClusteringKMedias.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrameClusteringKMedias().setVisible(true);
            }
        });
    }
